/** Converts risk reasons into concrete protective actions and execution hints. */
import type { AppConfig, NormalizedPosition, Recommendation, RiskReason } from './types';

/** Builds the recommendation list for a flagged position. */
export function buildRecommendations(
  ...
  // Recommendations are generated per triggered rule so the rationale stays explainable.
...
/** Removes repeated recommendations that can be produced by overlapping rules. */
